...
- **IRC:** #free-rms on [freenode](https://freenode.net) ([webchat](https://kiwiirc.com/client/irc.freenode.net/#free-rms)) (Jabber gateway : `#free-rms%chat.freenode.net@biboumi.marc-o.win` ) ([matrix gateway](https://matrix.to/#/!mWZODMOmEDtkkzUIUZ:matrix.org?via=matrix.org&via=monorail.modular.im&via=footbridge.xyz) )

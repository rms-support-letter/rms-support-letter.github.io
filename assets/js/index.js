...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"dropdown.ts":[function(require,module,exports) {
"use strict";
...
var renderDropdown = function renderDropdown(node) {
  console.log({
    node: node
  });
...
var initDropdown = function initDropdown() {
  return window.addEventListener('load', function () {
    var dropdowns = document.querySelectorAll('.translations .dropdown');
...
dropdown_1.initDropdown();
},{"./dropdown":"dropdown.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
